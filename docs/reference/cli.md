...
| `make build-agents`     | Build all six agent runtime images (`claude_code`, `cursor_cli`, `codex`, `gemini_cli`, `grok`, `kiro_cli`) plus the shared `agent-base-core`. Agents build in parallel. |
