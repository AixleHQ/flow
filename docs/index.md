...
- **[design/flow-insights-sharing.md](./design/flow-insights-sharing.md)** — First-party Flow ↔ Aixle Insights usage sharing: project opt-in, `afli_` connection token, pull API contract for completed session usage (no prompts/secrets)
