...
[TestCase("ru", 1, "1 coin")]
[TestCase("ru", 2, "2 coins")]
[TestCase("ru", 5, "5 coins")]
...
func test_plural_forms():
    ...
    assert_eq(tr_n("coin", "coins", 1), "1 coin")
    assert_eq(tr_n("coin", "coins", 2), "2 coins")
    assert_eq(tr_n("coin", "coins", 5), "5 coins")
    assert_eq(tr_n("coin", "coins", 21), "21 coin")
