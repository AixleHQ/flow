...
describe('BoardTaskChip', () => {
  ...
  it('links to the board card with number and title', () => {
    renderPage(<BoardTaskChip projectId={7} boardTask={{ id: 142, title: 'Fix login timeout', archived: false }} />);
  ...
  it('still links when the task is archived', () => {
    renderPage(<BoardTaskChip projectId={7} boardTask={{ id: 9, title: 'Archived card', archived: true }} />);
