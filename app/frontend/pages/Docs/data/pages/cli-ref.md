...
| `make build-agents`     | Build all seven agent runtime images (`claude_code`, `cursor_cli`, `codex`, `gemini_cli`, `antigravity_cli`, `grok`, `kiro_cli`) plus the shared `agent-base-core`. Agents build in parallel. |
