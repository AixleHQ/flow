...
export default defineConfig([
  ...
  // repositories-management needs integrations data to link repos to GitHub App installations
  {
    files: ['./app/frontend/features/repositories-management/**'],
    rules: {
      'fsd/forbidden-imports': 'off',
      'fsd/no-public-api-sidestep': 'off',
    },
  },
  // session-launch imports API hooks directly (Vite can't re-export RTK Query hooks via barrel)
  {
    files: ['./app/frontend/widgets/session-launch/**'],
    rules: {
      'fsd/no-public-api-sidestep': 'off',
    },
  },
