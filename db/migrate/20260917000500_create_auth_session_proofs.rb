...
class CreateAuthSessionProofs < ActiveRecord::Migration[8.1]
  def change
    create_table :auth_session_proofs do |t|
      t.references :auth_session, null: false, foreign_key: true, index: true
    ...
    add_index :auth_session_proofs, %i[auth_session_id identity_provider_id], unique: true,
              name: "index_auth_session_proofs_unique_pair"
  end
end
