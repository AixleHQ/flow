...
ActiveRecord::Schema[8.1].define(version: 2026_09_17_120000) do
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.text "description"
    t.string "insights_connection_token_digest"
    t.datetime "insights_connection_token_last_used_at"
    t.string "name", null: false
    t.bigint "owner_id", null: false
    t.string "preferred_artifacts_language", default: "en"
    t.jsonb "settings", default: {}, null: false
    t.boolean "share_usage_with_insights", default: false, null: false
    t.string "slug", null: false
    t.string "state", null: false
    t.datetime "updated_at", null: false
    ...
    t.index ["insights_connection_token_digest"], name: "index_projects_on_insights_connection_token_digest", unique: true, where: "(insights_connection_token_digest IS NOT NULL)"
  ...
  create_table "session_concurrency_limits", force: :cascade do |t|
    ...
    t.check_constraint "max_sessions > 0 AND (scope_type::text = ANY (ARRAY['Project'::character varying::text, 'User'::character varying::text]))", name: "valid_session_scope_limit"
  end
