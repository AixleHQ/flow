...
# =============================================================================
# Gemini CLI Container Entrypoint
#
# Starts:
...
# Set HOME for Gemini CLI
export HOME="/home/gemini"

echo ""
echo -e "${BLUE}═══════════════════════════════════════════════════════════════${NC}"
echo -e "${BLUE}  Gemini CLI Interactive Session${NC}"
echo -e "${BLUE}═══════════════════════════════════════════════════════════════${NC}"
echo ""
...
if [ -n "$GOOGLE_API_KEY" ]; then
    ...
    echo -e "${YELLOW}⚠️  GOOGLE_API_KEY not set - Gemini CLI will require configuration${NC}"
fi
...
# Default command is bash with gemini available, can be overridden with TTYD_CMD env var
...
echo -e "    gemini   - Start Google Gemini AI assistant"
